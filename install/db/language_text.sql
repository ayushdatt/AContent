...
('en', '_msgs', 'TR_ERROR_NOBODY_TO_SHARE_WITH', 'You must select a user or a user group to share the content', '2014-04-07 15:17:28', ''),
...
('en', '_msgs', 'TR_ERROR_USER_GROUP_EXISTS', 'The group name already exists. Please choose a different name', '2014-01-27 15:48:35', ''),
...
('en', '_msgs', 'TR_HELP_CREATE_AUTHOR_USER_GROUP', '<h2>Create User Group</h2>\r\n\r\n<p>The list of users can be seen and the user has to give a name to the user group he wants to create and the user has to select the users he wants to add to that group before submitting the form</p>', '2014-06-07 12:48:01', ''),
...
('en', '_msgs', 'TR_HELP_DIFFERENCE_VERSIONS', '<h3>Difference between two revisions</h3>\r\n<p>This section allows you to compare two revisions and see what changes were made at that time. There are two options to compare:</p>\r\n\r\n<ul>\r\n<li><strong>HTML/TEXT</strong>: Since the editor allows one to change the style of the text like bold, Italics. So one can compare in HTML but if one wishes to ignore the HTML and just compare the text then one can do it.</li>\r\n<li><strong>Inline/Side by Side</strong>:This option allows one to view the differences in different formats.</li></ul>', '2014-06-16 15:10:47', ''),
...
('en', '_msgs', 'TR_HELP_EXISTING_USER_GROUP', '<h2>Modify Existing User-Group</h2>\r\n\r\n<p>User Group created by the logged in user earlier can be modified and updated. The name of the usergroup can also be updated by clicling on the editable fields in the table.</p>', '2014-06-07 12:48:01', ''),
...
('en', '_msgs', 'TR_HELP_MANAGE_SHARE','<h2>Manage Shared Content</h2>\r\n\r\n<p>Access to contents shared with other users can also be revoked in this section.</p>', '2014-06-07 12:48:01', ''),
...
('en', '_msgs', 'TR_HELP_SHARE_CONTENT', '<h2>Share Pages</h2>\r\n\r\n<p>In this section the user can select a lesson completely or even a page of a lesson to share with a group or a user or both of them together.</p>', '2014-06-07 12:48:01', ''),
('en', '_msgs', 'TR_HELP_SHARE_MANAGE_CONTENT','<h2>Share Content</h2>\r\n\r\n	<p>This section allows users to share a page created by them with some other user or a group of users creted by the user so that the users with whom the content is shared can also edit the content shared with them.</p>\r\n\r\n<h3>Share Pages</h3>\r\n\r\n<p>In this section the user can select a lesson completely or even a page of a lesson to share with a group or a user or both of them together.<\p>\r\n\r\n<h3>Manage Shared Pages</h3>\r\n\r\n<p>Access to contents shared with other users can also be revoked in this section.</p>', '2014-06-07 12:48:01', ''),
...
('en', '_msgs', 'TR_HELP_USERGROUP', '<h2>Manage User Groups</h2>\r\n\r\n	<p>This section allows users to create user groups so that in future they can share contents with a user group instead of manually sharing a content with each user in the group. The user groups that are created by user can only be seen by the user himself and are a property of that user only.</p>\r\n\r\n<p>A user can create a new user group, modify the user group created by him earlier or delete the user groups created by him.</p>\r\n\r\n<h3>Creating User Group</h3>\r\n\r\n<p>The list of users can be seen and the user has to give a name to the user group he wants to create and the user has to select the users he wants to add to that group before submitting the form.\r\n\r\n<h3>Manage Existing User-Group</h3>\r\n\r\n<p><em>User Group</em> created by the logged in user earlier can be modified and updated. The name of the usergroup can also be updated by clicling on the editable fields in the table.</p>', '2010-06-17 16:03:26', ''),
...
('en', '_msgs', 'TR_HELP_VERSIONS', '<h3>Versions</h3>\r\n<p>This section allows you to see what was there in the previous version of the content and to revert it back to the previous version.The two parts are:</p>\r\n\r\n<ul>\r\n<li><strong>View Content</strong>: The previous revisions of the content are shown. Clicking on the hyperlink of that version takes you to the editor and if one saves it then that will be made current verion. It will then also show from which version it has been restored. </li>\r\n<li><strong>Show Differences</strong>: If the user clicks on two revisions of the content then the button with "Show Differences" gets highligted. Clicking on the button takes you to the difference between the versions. </li></ul>', '2010-06-16 15:10:47', ''),
('en', '_msgs', 'TR_HELP_VIEW_SHARED_CONTENT','<h2>View Contents Shared with Me</h2>\r\n\r\n	<p>This section allows users to view or edit content shared with me.</p>\r\n\r\n<h3>Locking</h3>\r\n\r\n<p>A user can only edit the content shared with him if the author of the content is not presently editing the content.<\p>\r\n\r\n<p>Suppose if the logged in user stays inactive for more then 15 minutes then the logged in user will get the lock assuming that the author forgot to close the editor and is away.</p>', '2014-06-07 12:48:01', ''),
...
('en', '_template', 'create_user_group', 'Create User Group', '2014-01-27 15:48:35', ''),
('en', '_template', 'created_by', 'Created By: ', '2014-01-27 15:48:35', ''),
('en', '_template', 'current', 'Current Version', '2010-04-07 13:26:02', ''),
...
('en', '_template', 'edit_user_group', 'Modify User Group', '2014-01-27 15:48:35', ''),
('en', '_template', 'edited_by', 'Edited By: ', '2014-01-27 15:48:35', ''),
...
('en', '_template', 'existing_user_groups', 'Existing User Groups', '2014-03-17 13:40:46', ''),
...
('en', '_template', 'groupname', 'Group Name', '2014-06-14 15:48:35', ''),
...
('en', '_template', 'inline', 'Inline', '2014-12-07 16:01:46', ''),
...
('en', '_template', 'manage_shared_content', 'Manage Shared Content', '2014-03-11 14:37:00', ''),
...
('en', '_template', 'modify_group', 'Modify Group', '2014-06-14 15:48:35', ''),
...
('en', '_template', 'pages_shared_with_me', 'Pages Shared With Me', '2014-01-03 14:59:23', ''),
...
('en', '_template', 'present_group_name', 'Group Name: %s', '2014-01-27 15:48:35', ''),
...
('en', '_template', 'reverted_from', 'Reverted From Version: ', '2014-01-27 15:48:35', ''),
('en', '_template', 'revisions', 'Old Revisions', '2014-06-07 12:40:53', ''),
...
('en', '_template', 'select_content_to_share', 'Select Content to Share', '2014-12-07 16:01:46', ''),
('en', '_template', 'select_directory', 'Please choose the folder you want to move the selected files to:', '2010-04-07 13:51:45', ''),
('en', '_template', 'select_groups_to_share_with', 'Select Groups to Share Content With', '2014-12-07 16:01:46', ''),
('en', '_template', 'select_users_to_share_with', 'Select Users to Share Content With', '2014-12-07 16:01:46', ''),
...
('en', '_template', 'shared_with_me', ' by <strong>%s</strong>', '2014-03-24 13:16:34', ''),
...
('en', '_template', 'side_by_side', 'Side by Side', '2014-12-07 16:01:46', ''),
...
('en', '_template', 'under_lesson', ' Under Lesson <strong>%s</strong>', '2014-03-24 13:16:34', ''),
...
('en', '_template', 'users_groups_manage', 'Manage User Groups', '2014-07-7 15:48:35', ''),
...
('en', '_template', 'versions_difference', 'Differences Between Versions', '2014-03-11 14:37:01', ''),
('en', '_template', 'view', 'View', '2010-01-27 15:48:35', ''),
('en', '_template', 'view_differences', 'View Differences', '2014-01-27 15:48:35', ''),
...
('en', '_template', 'view_user_group', 'Selected User Group', '2010-01-27 15:48:35', ''),
